...
syntax match   javascriptArrowFuncDef          /(\_[^)]*)\_s*=>/ contains=javascriptParens,javascriptArrowFuncArg,javascriptComma,javascriptArrowFunc nextgroup=javascriptOperator,javascriptIdentifierName,javascriptBlock,javascriptArrowFuncDef skipwhite skipempty
